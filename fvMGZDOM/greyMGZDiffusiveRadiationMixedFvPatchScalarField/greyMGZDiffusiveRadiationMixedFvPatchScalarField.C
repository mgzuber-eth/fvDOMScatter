...
#include "greyMGZDiffusiveRadiationMixedFvPatchScalarField.H"
...
Foam::radiation::greyMGZDiffusiveRadiationMixedFvPatchScalarField::
greyMGZDiffusiveRadiationMixedFvPatchScalarField
(
    const fvPatch& p,
...
greyMGZDiffusiveRadiationMixedFvPatchScalarField
(
    const greyMGZDiffusiveRadiationMixedFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
void Foam::radiation::greyMGZDiffusiveRadiationMixedFvPatchScalarField::
updateCoeffs()
{
    if (this->updated())
    {
    ...
    const fvMGZDOM& dom = db().lookupObject<fvMGZDOM>("radiationProperties");
    ...
    radiativeMGZIntensityRay& ray =
        const_cast<radiativeMGZIntensityRay&>(dom.IRay(rayId));
...
void Foam::radiation::greyMGZDiffusiveRadiationMixedFvPatchScalarField::write
(
    Ostream& os
) const
{
