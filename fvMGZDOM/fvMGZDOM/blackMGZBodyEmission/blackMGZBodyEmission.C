...
#include "blackMGZBodyEmission.H"
...
Foam::radiation::blackMGZBodyEmission::emissivePowerTable
{
    {  1000, 0.00032 },
    {  1100, 0.00091 },
    {  1200, 0.00213 },
...
Foam::radiation::blackMGZBodyEmission::blackMGZBodyEmission
(
    const label nLambda,
...
Foam::scalar Foam::radiation::blackMGZBodyEmission::fLambdaT
(
...
Foam::radiation::blackMGZBodyEmission::deltaLambdaT
(
    const volScalarField& T,
...
Foam::tmp<Foam::volScalarField>
Foam::radiation::blackMGZBodyEmission::EbDeltaLambdaT
(
    const volScalarField& T,
    const Vector2D<scalar>& band
) const
...
void Foam::radiation::blackMGZBodyEmission::correct
(
    const label lambdaI,
    const Vector2D<scalar>& band
)
