...
#include "blackBodyEmissionScatter.H"
...
Foam::radiationModels::blackBodyEmissionScatter::emissivePowerTable
(
    {
        { 1000, 0.00032},
        { 1100, 0.00091},
...
Foam::radiationModels::blackBodyEmissionScatter::blackBodyEmissionScatter
(
    const label nLambda,
...
Foam::scalar Foam::radiationModels::blackBodyEmissionScatter::fLambdaT
(
...
Foam::radiationModels::blackBodyEmissionScatter::deltaLambdaT
(
    const volScalarField& T,
...
Foam::tmp<Foam::volScalarField>
Foam::radiationModels::blackBodyEmissionScatter::EbDeltaLambdaT
(
    const volScalarField& T,
    const Vector2D<scalar>& band
) const
...
void Foam::radiationModels::blackBodyEmissionScatter::correct
(
    const label lambdaI,
    const Vector2D<scalar>& band
)
